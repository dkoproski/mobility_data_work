...
df_visitor = read_csv("Weekly_Patterns_Foot_Traffic_Full_Historical_Data-0-DATE_RANGE_START-2020-01-06.csv")
...
```{r}
df_census = read_csv("full_census_2020/full_census_2020.csv", skip = 1) |> 
  janitor::clean_names()
...
# Assuming 'id' is your unique identifier and you want to sum across all age groups for each identifier
