...
```{r}
  df_model = df_long |> 
    filter(top_category %in% c(target_categories, medical_services)) |>  # Filter to only relevant POIs
    mutate(category_indicator = if_else(top_category %in% target_categories, "rest/bar", "med"))
