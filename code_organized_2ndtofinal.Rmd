...
```{r}
#excise visitors from hawaii
flow_df = final_df |> 
  filter(vis_long > -150) 
# |> filter(total_visitors < 20)
...
#  scale_color_gradient2(low = "lightblue", mid = "green", high = "darkred", midpoint = 3) +
#  scale_color_gradientn(colors = blues9, guide = "colourbar", na.value = "gray50", space = "Lab") +
